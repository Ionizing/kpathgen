...
static const KPath kpath_dat[30] = {
  ...
  { // cP1
    ...
    .n_paths          = 7,
    .highsym_points   = {
      {.symbol = _hsp_GAMMA, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_R, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_M, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_X, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_X_1, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_X    },
      {_hsp_X,        _hsp_M    },
  ...
  { // cF1
    ...
    .highsym_points   = {
      {.symbol = _hsp_GAMMA, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_X, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_L, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_W, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_W_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_K, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_U, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_X},
      {_hsp_X,        _hsp_U},
  ...
  { // cI1
    ...
    .highsym_points   = {
      {.symbol = _hsp_GAMMA, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_H, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_P, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_N, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path = {
      {_hsp_GAMMA,    _hsp_H},
      {_hsp_H,        _hsp_N},
  ...
  },
  {
    ...
    .highsym_points   = {
      {.symbol = _hsp_GAMMA, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Z, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_M, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_A, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_R, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_X, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_M, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_X, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_G, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_P, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Z, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Z_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_N, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path = {
      {_hsp_GAMMA,    _hsp_X},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_P, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_N, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_S_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_S, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_R, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_G, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_Z, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_U, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Y, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_S, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_T, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_R, .coordinate = {-1.0, -1.0, -1.0} }, 
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_X},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_Z, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Y, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_SIGMA_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_U_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_A_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_C_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_L, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_Y},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_Z, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Y, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_LAMBDA_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Q_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_G_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_H_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_L, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_T},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_A_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_C_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_B_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_D_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_G_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_H_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_L, .coordinate = {-1.0, -1.0, -1.0} },
    },
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_W, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_SIGMA_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_F_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_Y_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_U_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_L_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_M_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_J_0, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_X},
      {_hsp_X,        _hsp_F_2},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol =	_hsp_W, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Y_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_U_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_LAMBDA_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_G_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_K, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_K_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_K_4, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_X},
      {_hsp_X,        _hsp_U_2},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol = _hsp_W, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_SIGMA_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_F_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_LAMBDA_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_G_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_V_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_H_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol = _hsp_H_2, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_X},
      {_hsp_X,        _hsp_F_0},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol =	_hsp_C_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_A_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_E_0, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_Y},
      {_hsp_Y,        _hsp_C_0},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol =	_hsp_Y, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_T, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_T_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Z, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Z_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_S, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_R, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_R_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_DELTA_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_F_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_B_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_B_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_G_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_G_2, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol =	_hsp_T, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_L, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_L_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_L_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_F, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_F_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_S_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_S_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_S_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_S_6, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_6, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M_6, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M_8, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_T},
      {_hsp_T,        _hsp_H_2},
  ...
  },
  {
    ...
    .highsym_points   = {
      {.symbol =	_hsp_GAMMA, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_T, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_P_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_P_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_R_0, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_L, .coordinate = {-1.0, -1.0, -1.0} }, 
      {.symbol =	_hsp_F, .coordinate = {-1.0, -1.0, -1.0} },
  ...
  },
  {
    ...
    .highsym_points   = {
      {.symbol =	_hsp_GAMMA, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Z, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_B, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_B_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Y, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Y_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_C, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_C_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_D, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_D_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_A, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_E, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M, .coordinate = {-1.0, -1.0, -1.0} },
  ...
  },
  {
    ...
    .highsym_points   = {
      {.symbol =	_hsp_GAMMA, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Y_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_Y_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_A, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_M_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_V, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_V_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_L_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_C, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_C_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_C_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_D, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_D_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_E, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_E_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_E_4, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_C},
      {_hsp_C_2,      _hsp_Y_2},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol =	_hsp_F, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_F_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_F_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_G, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_G_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_G_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_G_6, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_Y},
      {_hsp_Y,        _hsp_M},
  ...
  },
  {
    ...
    .highsym_points   = {
      ...
      {.symbol =	_hsp_V_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_L_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_I, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_I_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_K, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_K_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_K_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_H, .coordinate = {-1.0, -1.0, -1.0} },
      ...
      {.symbol =	_hsp_H_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_N, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_N_2, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_N_4, .coordinate = {-1.0, -1.0, -1.0} },
      {.symbol =	_hsp_N_6, .coordinate = {-1.0, -1.0, -1.0} },
    },
    .path             = {
      {_hsp_GAMMA,    _hsp_A},
      {_hsp_A,        _hsp_I_2},
